...
No valid <b>AWS Accounts</b> were found for the the <b>Lambda</b>. This is a problem with Now itself and please reach out to us [for support](mailto:team@zeit.co).
