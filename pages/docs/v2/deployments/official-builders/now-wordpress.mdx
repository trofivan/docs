...
- Create a `wp-content/themes` directory in your project root directory and upload the theme folder to it.
- Then, run the `now` command.
...
- Unzip the zip file contents.
- Create a `wp-content/plugins` directory in your project root directory and upload the plugin folder to it.
- Run the now command.
