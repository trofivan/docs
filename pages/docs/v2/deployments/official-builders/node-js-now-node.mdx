...
export const meta = {
  ...
  lastEdited: '2019-05-13T14:03:06.000Z'
}
...
<Note>
  The <InlineCode>@now/node</InlineCode> builder also{' '}
  <P.B>supports asynchronous functions</P.B>, an example of which can be found
  in the{' '}
  <GenericLink href="/docs/v2/deployments/official-builders/node-js-now-node#request-bodies">
    Request Bodies
  </GenericLink>{' '}
  section.
</Note>
...
Handling request bodies in Node.js functions without the use of a framework requires one extra step.
...
The code to do this, as taken from the [documentation](https://nodejs.org/ja/docs/guides/anatomy-of-an-http-transaction/#request-body), has been put into an example below:
...
<Caption>An example asynchronous Node.js function.</Caption>

For more information on handling request bodies in Node.js, you can [read the short guide](/guides/handling-node-request-body-with-micro) to understand how it works in greater detail.
