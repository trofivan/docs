...
<Note warning>
  ...
  prevents you from receiving the full benefits of the ZEIT DNS such as the
  ...
  this is likely to <P.B>slow down your applications</P.B>.
</Note>
...
<Note>
  If you have lost the value before verifying the domain, you can use{' '}
  <InlineCode>
